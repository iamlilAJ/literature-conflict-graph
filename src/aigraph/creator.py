...
CREATOR_SYSTEM_PROMPT = (
    ...
    "- GROUNDING (hard): each prediction MUST cite a specific number or benchmark "
    "result from the claims (e.g. 'closes the 13.79% HumanEval gap'), never a generic "
    "'improves accuracy'. Tie proposed_method to a specific claim's quantitative "
    "finding.\n\n"
...
SYSTEM_PROMPT_COARSE = (
    ...
    "- ground >=1 prediction in a specific number from the evidence\n"
...
SYSTEM_PROMPT_SYNTHESIZE = (
    ...
    "concrete minimal_test); preserve at least one concrete prediction tied to a named "
    "benchmark NUMBER from FINE\n"
